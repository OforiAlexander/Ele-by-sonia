...
const NAV = [
  ...
  { key: 'categories',   label: t(KEYS.nav.categories),   to: '/categories' },
  { key: 'sales',        label: t(KEYS.nav.sales),        to: '/pos' },
  { key: 'salesHistory',  label: t(KEYS.nav.salesHistory),  to: '/sales' },
  { key: 'transactions',  label: t(KEYS.nav.transactions),  to: '/transactions' },
